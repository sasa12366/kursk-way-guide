...
const About = () => {
  ...
  const facts = [
    ...
    },
    {
      ...
      description: "Знаменский кафедральный собор XVII века — Назван в честь чудотворной иконы Божией Матери «Знамение» Курская-Коренная"
    },
    {
    ...
    {
      title: "Курская Антоновка",
      description: "Курская область славится своими яблоневыми садами, а курская Антоновка считается одним из лучших сортов яблок в России"
    }
  ];
